...
function onSubmit(token) {
    ...
    // alert(email[0].value)
    if (email[0].value == "" && phone[0].value == "") {
        Swal.fire({
            icon: 'error',
            title: 'Oops...',
            text: 'You cannot leave the phone or email field empty',
        })
    }
        ...
        Swal.fire({
            icon: 'error',
            title: 'Oops...',
            text: 'You cannot leave the "message" field empty',
        })

    }


    else if (regex.test(email[0].value)) {
